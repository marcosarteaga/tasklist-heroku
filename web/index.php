...
echo "<input type='text' class='form-control' name='tareaNueva'>";
echo "&nbsp";
...
while ($row = $stmt->fetch()) {
    ...
    echo $row['name'];
    echo "&nbsp";
    echo"<input type='button' class='btn btn-warning' value='Eliminar' name='botonEliminar' onclick=location.href='/?id=".$row['id']."'         >";
    echo "</li>";
}
echo "</ul>";
echo "</form>";
